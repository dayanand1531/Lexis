...
public class Utils {
    ...
    public static Bitmap getBitmap(Drawable drawable, int width, int height) {
        ...
        } else if (drawable instanceof androidx.vectordrawable.graphics.drawable.VectorDrawableCompat) {
            return getBitmap((androidx.vectordrawable.graphics.drawable.VectorDrawableCompat) drawable, width, height);
    ...
    private static Bitmap getBitmap(androidx.vectordrawable.graphics.drawable.VectorDrawableCompat vectorDrawable, int width, int height) {
        Bitmap bitmap = Bitmap.createBitmap(width, height, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(bitmap);
        vectorDrawable.setBounds(0, 0, canvas.getWidth(), canvas.getHeight());
        vectorDrawable.draw(canvas);
